...
|------------|--------------|-----------|-------------|--------------|
| settlement_batch | 500 | 6000000 | 944.14 MB | 750.00 MB |
| payment_instruction | 500 | 15000000 | 8.10 GB | 2.52 GB |

## Atlas sizing (from dbStats scaling)

- Production document count (database): **21000000**
- Compression ratio: **0.6481**
- Sizing basis: **measured-storage**
- Data size (production): **7.29 GB**

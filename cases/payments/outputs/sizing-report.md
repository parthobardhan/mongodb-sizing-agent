...
- Objects (sample): **1000**
- Avg object size: **361.21 B**
- Data size: **352.75 KB**
- Storage size: **128.00 KB**
...
|------------|--------------|-----------|-------------|--------------|
| settlement_batch | 500 | 6000000 | 864.03 MB | 750.00 MB |
| payment_instruction | 500 | 15000000 | 7.98 GB | 2.52 GB |

## Atlas sizing (from dbStats scaling)

- Production document count (database): **21000000**
- Compression ratio: **0.6371**
- Sizing basis: **measured-storage**
- Data size (production): **7.06 GB**
- Storage size (production): **2.56 GB**
- Index size (production): **3.04 GB**
- RAM usage estimate (index × 1.5): **4.57 GB**
- **Disk required** (storage / 0.75): **3.42 GB**
